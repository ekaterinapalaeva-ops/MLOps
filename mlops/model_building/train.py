...
mlflow.set_tracking_uri("https://greedy-zoology-periscope.ngrok-free.dev")   # complete the code to set the MLflow tracking URI
mlflow.set_experiment("mlops_tourism_package_prediction")     # complete the code to set the MLflow experiment name (same as the dev experimentation cell)
...
numeric_features = ["Age", "DurationOfPitch", "CityTier", "NumberOfPersonVisiting", 
...
param_grid = {
    ...
    'xgbclassifier__reg_lambda': [1.0, 5.0],          # L2 regularization strength. Higher values help reduce overfitting.
}
# Model pipeline
...
with mlflow.start_run():
    ...
    model_path = "mlops/deployment/tourism_model.joblib"   # Specify the local file path (inside tourism_project/deployment/) where the trained model should be saved.
